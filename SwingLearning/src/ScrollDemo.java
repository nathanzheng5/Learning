...
//        picture = new ScrollablePicture(bee, columnView.getIncrement());
        picture = new ScrollablePicturePane(bee);
...
//        pictureScrollPane.setViewportView(picture);
        ...
        addImageButton = new JButton(new AbstractAction("Add") {
            @Override
            public void actionPerformed(ActionEvent e) {
                ((ScrollablePicturePane)picture).addImageIcon();

                BoundedRangeModel model = pictureScrollPane.getVerticalScrollBar().getModel();
                System.out.println("model value = " + model.getValue() + ", max = " + model.getMaximum());
            }
        });
        buttonCorner.add(addImageButton);
